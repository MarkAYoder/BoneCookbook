...
image::figures/bglb_0917.png[Board outline in Chrome]
...
image::figures/bglb_0918.png[PCB orginal baord]

Hide all but the Board Layer (<<capes_fritzing2>>).

[[capes_fritzing2]]
.PCB with all but the Board Layer hidden
image::figures/bglb_0919.png[PCB orginal baord hidden]
...
image::figures/bglb_0920.png[PCB load image file]
...
image::figures/bglb_0921.png[PCB selecting svg file]
...
.PCB Inspector
image::figures/bglb_0922.png[PCB Inspector]
...
image::figures/bglb_0923.png[Schematic for miniDisplay]

[[capes_miniDisplay_pcb]]
.PCB for MiniDisplay cape
image::figures/bglb_0924.png[PCB for miniDisplay]
...
image::figures/bglb_0925.png[Eagle License]
...
image::figures/bglb_0926.png[Eagle install destination directory]
...
image::figures/bglb_0927.png[Eagle start screen]
...
image::figures/bglb_0928.png[Converter Output]
