...
image::images/bglb_0202.png[Cape Headers P8 and P9]
...
image::images/bglb_0203.png[Sensor Connection Modes]
...
image::images/bglb_0204.png[Cloud9 bash tab]
...
[NOTE]
====
((("b.pinMode()")))((("pinMode()")))((("b.attachInterrupt()")))((("attachInterrupt()")))In this example, I've called +b.pinMode()+ asynchronously and performed the +b.attachInterrupt()+ call within the callback function. There are cases where BoneScript version 0.2.4 might not completely finish setting up a pin's mode when called synchronously. That might result in needing to run a program twice to overcome the error. Using asynchronous calls is the preferred strategy to avoid this issue.
====
...
image::images/bglb_0121.png[Bone with pushbutton]
...
include::images/sensors/pushbutton.js[]
...
If you want to use the magnetic reed switch wired as shown in <<js_pushbutton_fig>>, change +P9_42+ to +P9_26+. 
...
image::images/bglb_0207.png[Seven analog inputs on P9 header]
...
image::images/bglb_0208.png[Analog]
...
include::images/sensors/analogIn.js[]
...
[NOTE]
====
(((".toFixed()", primary-sortas="toFixed()")))This code in <<sensors_analogIn_code>> uses +.toFixed(3)+ to print only three digits past the decimal. Otherwise, the output could have many extra digits. Try removing +.toFixed(3)+ and see what happens.
====
...
image::images/bglb_0209.png[Flex Resistor]
...
image::images/bglb_0211.png[Analog]
...
include::images/sensors/ultrasonicRange.js[]
...
image::images/bglb_0212.png["HC-SR04 Ultrasonic Sensor"]
...
image::images/bglb_0213.png["Wiring an HC-SR04 Ultrasonic Sensor"]
...
include::images/sensors/hc-sr04-ultraSonic.js[]
...
image::images/bglb_0214.png[rotaryEncoder]
...
Here, we'll use the _eQEP2_ encoder. To enable it, put the code from <<digital_bone_eqep2b>> in a file called _bone_eqep2b.dts_. You can do this using Cloud9 to edit files (as shown in <<basics_cloud9>>) or use a more traditional editor (as shown in <<tips_editing_files>>).

[[digital_bone_eqep2b]]
.Configuring a rotary encoder (bone_eqep2b.dts) footnote:[This solution first appeared on the  https://groups.google.com/forum/#!searchin/beagleboard/eQep/beagleboard/Orp3tFcNgCc/mYacP_GkCQQJ[Beagle Google Group].]
====
[source,c,subs="-callouts"]
----

include::images/sensors/bone_eqep2b.dts[]
...
This will enable _eQEP2_ on pins +P8_11+ and +P8_12+.  
...
include::images/sensors/rotaryEncoder.js[]
...
image::images/bglb_0216.png[GPS]
...
image::images/bglb_0218.png[I^2^C  Temp]
...
image::images/bglb_0219.png[I^2^C  Temp]
...
include::images/sensors/i2cTemp.js[]
...
image::images/bglb_0220.png[1-wire]
...
include::images/sensors/BB-W1-00A0.dts[]
...
include::images/sensors/onewire.js[]
...
.SensorTag
image::images/bglb_0221.png[SensorTag]
...
include::images/sensors/sensorTag.js[sensorTag.js]
...
[[usb_audio_dongle]]
.A USB audio dongle
image::images/bglb_0222.png[Audio Dongle]
...
include::images/sensors/audio.asoundrc[]
