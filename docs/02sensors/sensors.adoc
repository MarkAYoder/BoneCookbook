...
All these examples assume that you know how to edit a file (<<basics_cloud9>>) and run it, either within the Visual Studio Code (VSC) integrated development environment (IDE) or from the command line (<<tips_shell>>).
