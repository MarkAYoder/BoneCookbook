...
=== Mapping Header number to gpio numbers
...
The numbers following the string +gpio+ are the port number and the pin on that port.  In this cse it's port 0 and pin 7.  To find the gpio number multiply the port number by 32 and add it to the pin number.  This give 0*32+7=7.  For P9_26 you get:
