...
Place the code shown in <<js_internLED_code>> in a file called _internLED.js_. You can do this using VSC to edit files (as shown in <<basics_vsc>>) or with a more traditional editor (as shown in <<tips_editing_files>>).
