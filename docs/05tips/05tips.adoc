...
image::figures/leafpad.png[leafpad]
...
image::figures/wicd.png[wicd opening view]
...
image::figures/wicdPrefs.png[Setting preferences in wicd]
...
image::figures/wicdConfig.png[Configuring a network in wicd]
...
image::figures/wicdSecure.png[Configuring authentication in wicd]

[[tips_wicd_password_fig]]
.Entering password in wicd
image::figures/wicdPassword.png[Entering password in wicd]
...
image::figures/wicdConnected.png[Connected to a network via wicd]
...
image::figures/bglb_0518.png[cape headers digital]
