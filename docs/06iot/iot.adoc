...
image::figures/apacheIndex.png[test.html served by Node.js]
...
include::code/server.js[simple Node.js-based web server]
...
image::figures/nodeServer.png[Test page]
...
image::figures/GPIOWebPage.png[GPIO status]
...
image::figures/jQueryFiddle.png[jsfiddle example of GPIO]
