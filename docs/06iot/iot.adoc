...
[start=5]
. Click on the link,  http://developer.twitter.com/en/apps[] shown in <<networking_node_twitter_auth2_fig>>, and follow the steps to set up your twitter app. Copy from there your *API key* etc.  
