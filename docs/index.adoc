...
. link:02sensors/sensors.html[Sensors]
  ...
  ** [x] Input and Run a JavaScript Application for Talking to Sensors
  ...
  ** [x] Commented out: Reading a Distance Sensor (Variable Pulse Width Sensor)
  ** [x] Accurately Reading the Position of a Motor or Dial
  ** [x] Commented out: Acquiring Data by Using a Smart Sensor over a Serial Connection
...
. link:03displays/displays.html[Displays]
  ...
  ** [x] Toggling an External LED via gpiod
  ** [x] Toggling a High-Voltage External Device
...
. link:05tips/tips.html[Beyond Basics]
  ...
  ** [x] Removed: Selecting an OS for Your Development Host Computer
...
. link:06iot/iot.html[Internet of Things]
  ...
  ** [x] Wiring the IoT with Node-RED
...
. link:07kernel/kernel.html[The Kernel]
  ** [ ] Introduction
  ** [x] Updating the Kernel
  ** [x] Building and Installing Kernel Modules
  ** [x] Controlling LEDs by Using SYSFS Entries
  ** [x] Controlling GPIOs by Using SYSFS Entries
  ** [x] Compiling the Kernel
  ** [x] Using a Cross Compiler
  ** [ ] Applying Patches
...
. link:08realtime/realtime.html[Real-Time I/O]
  ...
  ** [x] Comented out: I/O with simpPRU
