...
image::images/bglb_0801.png[Bone with pushbutton and LED]
...
include::images/realtime/pushLED.js[]
...
include::images/realtime/pushLED.c[]
...
image::images/bglb_0802.png[Bone with pushbutton and LED wired to P9_13]
...
include::images/realtime/pushLEDmmap.h[pushLEDmmap.h]
...
include::images/realtime/pushLEDmmap.c[pushLEDmmap.c]
...
include::images/realtime/thumb.patch[]
...
.Configuing Xenomai
image::images/bglb_0803.png[HDMI Adaptor]
...
include::images/realtime/pruSpeak.py[]
...
image::images/bglb_0804.png[Bone with pushbutton and LED for PRU]
