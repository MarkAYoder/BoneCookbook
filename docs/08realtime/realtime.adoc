...
==== Problem
((("input/output (I/O)", "with Python")))((("Python", "input/output (I/O) with")))You want to read an input pin and write it to the output as quickly as possible with Python.
